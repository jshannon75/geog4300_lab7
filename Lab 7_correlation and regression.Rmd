...
**Question 6 (3 points)** _Summarize the results of the models in question 5, focusing on the direction and significance of the model coefficients, the model residuals, and the overall R2 value._
...
**Question 9 (3 points)** _Use a qq plot and a map to assess the normality of residuals and any spatial clustering. Summarise any notable patterns that you see._
...
**Question 11 (2 points)** _Looking at the full model and your diagnostics, do you feel this is a model that provides meaningful results? Explain your answer. What's one issue that should be improved if continuing to develop this model?_
